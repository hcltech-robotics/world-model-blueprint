# Benchmark: Infrastructure orchestration lead

## Purpose

Evaluate whether the skill can produce Execution lane decision and run plan from authoritative records, identify missing evidence, and route downstream work without inventing operational details.
...
- Required fields are checked against `schemas/run-request.schema.json`.
