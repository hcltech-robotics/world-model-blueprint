# Output contract: Infrastructure orchestration lead

## Required deliverable

Primary output: Execution lane decision and run plan.
...
- Required manifest validates against `schemas/run-request.schema.json`.
