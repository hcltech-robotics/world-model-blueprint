# Benchmark: SimReady content integration

## Purpose

Evaluate whether the skill can produce Simulation asset integration plan and SimReady asset manifest from authoritative records, identify missing evidence, and route downstream work without inventing operational details.
...
- Required fields are checked against `schemas/simready-asset-manifest.schema.json`.
