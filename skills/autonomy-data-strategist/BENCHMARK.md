# Benchmark: Autonomy data strategist

## Purpose

Evaluate whether the skill can produce Data adaptation brief and programme intake manifest from authoritative records, identify missing evidence, and route downstream work without inventing operational details.
...
- Required fields are checked against `schemas/programme-intake-manifest.schema.json`.
