# Benchmark: World model data factory

## Purpose

Evaluate whether the skill can produce Dataset production plan and dataset manifest from authoritative records, identify missing evidence, and route downstream work without inventing operational details.
...
- Required fields are checked against `schemas/dataset-manifest.schema.json`.
