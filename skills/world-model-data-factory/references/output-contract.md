# Output contract: World model data factory

## Required deliverable

Primary output: Dataset production plan and dataset manifest.
...
- Required manifest validates against `schemas/dataset-manifest.schema.json`.
