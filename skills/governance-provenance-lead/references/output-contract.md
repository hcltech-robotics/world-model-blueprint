# Output contract: Governance provenance lead

## Required deliverable

Primary output: Governance record and audit evidence map.
...
- Required manifest validates against `schemas/governance-record.schema.json`.
