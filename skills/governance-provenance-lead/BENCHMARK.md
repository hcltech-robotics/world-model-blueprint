# Benchmark: Governance provenance lead

## Purpose

Evaluate whether the skill can produce Governance record and audit evidence map from authoritative records, identify missing evidence, and route downstream work without inventing operational details.
...
- Required fields are checked against `schemas/governance-record.schema.json`.
