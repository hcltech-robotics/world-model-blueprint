# Benchmark: Real-time inference lead

## Purpose

Evaluate whether the skill can produce Inference service manifest and acceleration plan from authoritative records, identify missing evidence, and route downstream work without inventing operational details.
