# Benchmark: Deployment operations lead

## Purpose

Evaluate whether the skill can produce Deployment operations plan and service handoff from authoritative records, identify missing evidence, and route downstream work without inventing operational details.
...
- Required fields are checked against `schemas/inference-service-manifest.schema.json`.
