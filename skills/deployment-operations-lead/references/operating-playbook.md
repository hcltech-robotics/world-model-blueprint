# Operating playbook: Deployment operations lead

## Role in the blueprint

Role: turn a candidate model or service into an operated capability with visible authority boundaries and recovery paths.
...
```bash
scripts/wmb new-manifest --schema schemas/inference-service-manifest.schema.json --output artifacts/deployment-operations-lead.json
scripts/wmb validate-manifest --schema schemas/inference-service-manifest.schema.json --manifest artifacts/deployment-operations-lead.json
