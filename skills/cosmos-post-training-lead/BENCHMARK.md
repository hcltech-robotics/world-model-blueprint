# Benchmark: Cosmos post-training lead

## Purpose

Evaluate whether the skill can produce Training run manifest and post-training plan from authoritative records, identify missing evidence, and route downstream work without inventing operational details.
...
- Required fields are checked against `schemas/training-run-manifest.schema.json`.
