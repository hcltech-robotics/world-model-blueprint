# Output contract: Cosmos post-training lead

## Required deliverable

Primary output: Training run manifest and post-training plan.
...
- Required manifest validates against `schemas/training-run-manifest.schema.json`.
